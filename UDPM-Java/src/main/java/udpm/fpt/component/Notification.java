...
public class Notification extends javax.swing.JComponent {
    ...
    public Notification(Type type, Location location, String message) {
        this.fram = null;
        this.type = type;
        this.location = location;
        initComponents();
            ...
            public void begin() {
                if (!showing) {
                    ...
                    if (location == Location.TOP_CENTER) {
                        ...
                        y = fram.getY() + fram.getHeight() - dialog.getHeight();
                        top_to_bot = false;
                    }else if(location == Location.DEFAULT_DESKTOP){
                        x = screenBounds.x + screenBounds.width - dialog.getWidth() - margin;
    ...
    public static enum Location {
        TOP_CENTER, TOP_RIGHT, TOP_LEFT, BOTTOM_CENTER, BOTTOM_RIGHT, BOTTOM_LEFT, CENTER, DEFAULT_DESKTOP
    }
