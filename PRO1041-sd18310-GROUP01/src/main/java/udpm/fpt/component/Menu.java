...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("exit.png", "SaleMilk", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("exit.png", "SaleBill", Model_Menu.MenuType.MENU));
    }
